...
impl ImuEKF9 {
    ...
    pub fn compute(&mut self, angular_velocity : Vector3<f32>, linear_accel : Vector3<f32>, mag_field : Vector3<f32>, dt : f32)
    {
    ...
    fn predict(&mut self, angular_velocity : Vector3<f32>, dt : f32)
    {
        ...
        let f = Matrix3::<f32>::new(
            1.0, tan_y*sin_x, tan_y*cos_x,
            0.0, cos_x, -sin_x,
            0.0, sin_x/cos_y, cos_x/cos_y
        );
