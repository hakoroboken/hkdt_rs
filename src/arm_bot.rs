...
impl MotorData {
    pub fn new()->Self
    {
        Self {first_count: 0, count: -1, revolution: 0, position: 0.0, velocity: 0, current: 0 }
    }
}
        ...
        else 
        {
            ...
            for i in 0..3
            {
                ...
                else
                {
                    ...
                    self.motors[i].position = self.motors[i].revolution as f32 + (motors[i].count - self.motors[i].first_count) as f32 / 8192.0;
                }
            }
        }
    }
